      ...
      *-----------------------------------------------------------------
      * CNTRLBR1
      * Workshop 18.4 (Optional)
      * all coding of inner control break level removed, 2 changes at
      * calcutlating totals for remaining control break marked with
      * "R.S."
      *
      * Changes applied 08/23/2020 Ralf Straube
      *-----------------------------------------------------------------
       AUTHOR. IBM.
      ...
      *R.S     ADD HOLD-AMOUNT             TO AMOUNT-BY-WARD.
           ADD HOLD-AMOUNT             TO AMOUNT-BY-HOSP.
      *R.S     ADD 1                       TO PATIENT-COUNT-BY-WARD.
           ADD 1                       TO PATIENT-COUNT-BY-HOSP.
